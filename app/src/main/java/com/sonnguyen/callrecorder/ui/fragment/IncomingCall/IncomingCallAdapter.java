...
public class IncomingCallAdapter extends RecyclerView.Adapter<IncomingCallAdapter.ViewHolder> {
    ...
    public IncomingCallAdapter(List<RecordModel> mList, Context mContext) {
        this.mList = mList;
    ...
    @Override
    public void onBindViewHolder(@NonNull IncomingCallAdapter.ViewHolder holder, int position) {
